---
name: "research-note"
description: "Investigates a question against primary sources and lands the findings as a durable, cited Markdown note in the repo. Use this skill when the user says \"research X and write it up\", \"look into this and leave notes in the repo\", \"document what you find about Y\", or wants reading legwork turned into a permanent reference. Not for quick inline fact checks, verifying a single claim before acting, or summarizing a document the user supplies."
license: "MIT"
metadata:
