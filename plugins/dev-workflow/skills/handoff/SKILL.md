...
name: handoff
description: >-
  Produces a structured handoff of in-flight work the next session or person
  can act on without the conversation. Use when the user says "handoff", "hand
  this off", or "handoff notes", or wants to document where things stand
  before stopping or transferring work. Not for incident retrospectives
  (postmortem), tickets for unstarted work (define-work-items), or checking a
  doc stands alone (cold-read).
license: MIT
metadata:
