...
description: >-
  ...
  buildable. Not for system-wide architecture documents, not for
  breaking a discussion into individual tickets with acceptance
  criteria (define-work-items), and not for eliciting requirements
