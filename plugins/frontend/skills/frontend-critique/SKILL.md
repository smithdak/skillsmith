...
description: >-
  Runs a structured UX design review of a finished interface and lands
  a scored report: design-specificity verdict, Nielsen heuristics
  scored 0-4 with renormalization, cognitive-load checklist, persona
  red flags, and P0-P3 issues each with a concrete fix and the skill
  that should apply it. Use this skill when the user says "critique
  this page", "review the design", "what do you think of this UI",
  "score our landing page's design", or wants a design assessment
  before deciding what to change. Not for applying fixes
  (frontend-redesign), building new UI (frontend-craft), verifying
  behavior in a browser (webapp-testing), or security review.
license: MIT
metadata:
