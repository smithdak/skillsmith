...
description: >-
  Maps an unfamiliar repository fast: inventory scripts plus parallel
  subagent scans, synthesized into a path-anchored survey document. Use when
  the user says "survey this codebase", "help me get oriented in this repo",
  "map out this project", or has inherited a codebase. Not for judging its
  structure (architecture-review), a new design (architecture-spec), one bug
  (diagnose-bugs), or one function.
license: MIT
metadata:
