...
description: "Authors a repository's SECURITY.md interactively: scope, security invariants, what is in and out of bounds, reportability criteria, and accepted risks — with a diff preview and an approval gate before writing. Use this skill when the user says \"write a SECURITY.md\", \"define our security policy\", \"document what's in scope for security reports\", or \"set up a vulnerability disclosure policy\". Not for modeling threats, reviewing a change, or proposing fixes to existing findings."
license: "MIT"
metadata:
