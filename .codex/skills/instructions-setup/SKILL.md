...
description: "Persists the communication contract into AGENTS.md, CLAUDE.md, or global files as a managed block. Use when the user says \"set up the communication contract in this repo\", \"/instructions-setup\", \"persist these reply rules\", or \"make the agent report honestly project-wide\". Not for the rules (communication-contract), agent instructions in general (writing-for-agents), or READMEs (readme-authoring)."
license: "MIT"
metadata:
