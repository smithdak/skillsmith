---
name: "brand-voice"
description: "Extracts a brand voice specification from existing copy samples: identifies tone, vocabulary patterns, sentence structure, and anti-patterns, then produces a durable voice spec other content can be checked against. Use this skill when the user says \"extract our brand voice\", \"document our tone of voice\", \"what is our writing style\", \"create a voice guide from our copy\", \"our content sounds inconsistent — define our voice\", or provides copy samples and wants a reusable voice standard. Not for rewriting existing content to match a voice, scoring content quality, or creating general style guides for code or documentation."
license: "MIT"
metadata:
