...
name: postmortem
description: >-
  Writes an incident or bug post-mortem once the root cause is known:
  evidence-anchored timeline, mechanism, why every safety net missed it,
  guardrails. Use when the user says "write a post-mortem for this outage",
  "do an RCA on this bug", or wants a found root cause documented. Not for
  finding the cause (diagnose-bugs), what could fail
  (failure-mode-analysis), or tickets (define-work-items).
license: MIT
metadata:
