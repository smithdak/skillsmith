...
name: doc-visuals
description: >-
  Crafts the visual layer of technical docs — directory trees, mermaid
  diagrams, code blocks, tables — so structure lands at a glance and survives
  rendering. Use when the user says "add a diagram", "the repo map is hard to
  read", "make this README scannable", or a diagram renders broken. Not for
  prose (prose-hygiene), splitting content (information-architecture), or
